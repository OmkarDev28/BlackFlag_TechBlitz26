...
async function GET(request) {
    ...
    if (session.role === 'PATIENT') {
        try {
            ...
            const appointments = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].appointment.findMany({
                where: {
                    patient: {
                        phone: session.phone
                    }
            ...
            const clinicMap = new Map(clinics.map((c)=>[
                    c.clinicId,
                    c.clinicName
                ]));
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(enrichedAppointments);
        } catch (error) {
    ...
    if (!dateStr) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    ...
    try {
        ...
        if (session.role === 'PATIENT') {
            ...
            if (!targetClinicId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'clinicId is required for patient booking'
            }, {
                status: 400
            });
        } else {
            ...
            if (session.role !== 'RECEPTIONIST') {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: 'Only receptionists can book appointments for others'
                }, {
                    status: 401
                });
            }
        ...
        const conflict = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].appointment.findFirst({
            where: {
        ...
        let patient = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].patient.findFirst({
            where: {
                phone: patientPhone,
                clinicId: targetClinicId
            }
        ...
        if (!patient) {
            patient = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].patient.create({
                data: {
                    name: patientName,
                    phone: patientPhone,
                    clinicId: targetClinicId
        ...
        const appointment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].appointment.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3a73c53e._.js.map
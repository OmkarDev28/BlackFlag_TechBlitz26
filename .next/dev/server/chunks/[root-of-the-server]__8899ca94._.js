...
async function decrypt(input) {
    const { payload } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jwtVerify"])(input, SECRET, {
        algorithms: [
            'HS256'
        ]
    });
...
"[project]/src/app/api/clinics/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const clinics = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findMany({
            where: {
                role: 'DOCTOR',
                clinicId: {
                    not: null
        ...
        const uniqueClinics = Array.from(new Map(clinics.map((c)=>[
                c.clinicId,
                c
            ])).values());
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(uniqueClinics);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8899ca94._.js.map